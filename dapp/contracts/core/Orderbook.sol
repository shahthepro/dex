...
//         // dataStoreContract.delegatecall(bytes4(keccak256("whitelistContract(address)")), address(this));
//     }
...
//         if (is_bid) {
//             // // Buy order
//             // UserWallet.moveToEscrow(base, owner, volume);
//             // UserWallet.notifyBalanceUpdate(base, owner);
//         } else {
//             // // Sell order
//             // UserWallet.moveToEscrow(token, owner, volume);
//             // UserWallet.notifyBalanceUpdate(token, owner);
//         }
...
//         //     // // Buy Order
//         //     // UserWallet.recoverFromEscrow(pairBase, owner, volumeNoFee);
//         //     // // // UserWallet.releaseEscrow(pairBase, owner, owner, volumeNoFee);
//         //     // addToFeeAccount(pairBase, fee);
//         //     // UserWallet.notifyBalanceUpdate(pairBase, owner);
//         //     // UserWallet.notifyBalanceUpdate(pairBase, feeAccount);
//         // } else {
//         //     // // Sell Order
//         //     // UserWallet.recoverFromEscrow(pairToken, owner, volumeNoFee);
//         //     // addToFeeAccount(pairToken, fee);
//         //     // UserWallet.notifyBalanceUpdate(pairToken, owner);
//         //     // UserWallet.notifyBalanceUpdate(pairToken, feeAccount);
//         // }
...
//         // UserWallet.addToBalance(token, getFeeAccount(dataStoreContract), amount);
//     }
