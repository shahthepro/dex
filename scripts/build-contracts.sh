...
solc openzeppelin-solidity=$DEX_DAPP_LIB_DIR core/Orderbook.sol --combined-json abi,asm,ast,bin,bin-runtime,clone-bin,devdoc,interface,opcodes,srcmap,srcmap-runtime,userdoc > $DEX_DAPP_BUILD_DIR/Orderbook.json
# rm -rf $DEX_DAPP_LIB_DEST_DIR
)